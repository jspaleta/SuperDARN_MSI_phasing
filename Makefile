...
clean:
	rm -rf $(OBJECTS) $(EXECUTABLE) $(SUMMARY_OBJECTS) $(SUMMARY_EXECUTABLE) $(VERIFY_PROGRAMMED_OBJECTS) $(VERIFY_PROGRAMMED_EXECUTABLE) $(VERIFY_OBJECTS) $(VERIFY_EXECUTABLE) $(CONVERT_OBJECTS) $(CONVERT_EXECUTABLE) $(BEAM_OBJECTS) $(BEAM_EXECUTABLE) $(RF_EXECUTABLE) $(RF_OBJECTS)
